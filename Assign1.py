...
#2
tax=0.3*revenue 
new_profit=profit-tax
new_profit
print(np.round(new_profit,2))


--------

#3
margin=new_profit/revenue*100
np.round(margin,2)


mean=new_profit.mean()
round(mean,2)
...
#6
minimum=min(new_profit)
for i in range(12):
    if new_profit[i]==minimum:
        print(months[i])
        
 ---------
 
 #7
maximum=max(new_profit)
for i in range(12):
    if new_profit[i]==maximum:
        print(months[i])
...
for i in range(10):
    plt.plot(Seasons,Salary[i])
plt.legend(Players,loc='best')
plt.show()
...
#3
Salary_Goal=Salary/FieldGoals
for i in range(10):
    plt.plot(Seasons,Salary_Goal[i])
plt.legend(Players,loc='upper left')
plt.show()
...
#4
points_per_min = Points/MinutesPlayed
for i in range(10):
    plt.plot(points_per_min[i])
plt.legend(Players,loc='best')
plt.show()
...
for i in range(10):
    plt.plot(FieldGoals_per_game[i])
plt.legend(Players,loc='best')
plt.show()
...
#6
FieldGoals_per_attempt = FieldGoals/FieldGoalAttempts
for i in range(10):
    plt.plot(FieldGoals_per_game[i])
plt.legend(Players,loc='best')
plt.show()
...
#8
MinPlayed_per_game = MinutesPlayed/Games
for i in range(10):
    plt.plot(MinPlayed_per_game[i])
plt.legend(Players,loc='best')
plt.show()
...
#9
FieldGoals_per_minutes = FieldGoals/MinutesPlayed
for i in range(10):
    plt.plot(FieldGoals_per_minutes[i])
plt.legend(Players,loc='best')
plt.show()
...
#10
Points_per_FieldGoals = Points/FieldGoals
for i in range(10):
    plt.plot(Points_per_FieldGoals[i])
plt.legend(Players,loc='best')
plt.show()
